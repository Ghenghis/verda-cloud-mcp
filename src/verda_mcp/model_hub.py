...
LORA_PRESETS = {
    ...
    "qlora_4bit": LoRAConfig(
        r=64, lora_alpha=16, use_qlora=True, bits=4, target_modules=["q_proj", "v_proj", "k_proj", "o_proj"]
    ),
    "qlora_8bit": LoRAConfig(
        r=32, lora_alpha=64, use_qlora=True, bits=8, target_modules=["q_proj", "v_proj", "k_proj", "o_proj"]
    ),
}
...
LM_STUDIO_MODELS = {
    ...
    "llama3-70b-gguf": {
        "name": "lmstudio-community/Meta-Llama-3-70B-Instruct-GGUF",
        "quant": "Q4_K_M",
        "size_gb": 40,
        "vram": 48,
    },
    ...
    "phi3-mini-gguf": {
        "name": "lmstudio-community/Phi-3-mini-4k-instruct-GGUF",
        "quant": "Q4_K_M",
        "size_gb": 2.4,
        "vram": 4,
    },
    "codellama-34b-gguf": {
        "name": "lmstudio-community/CodeLlama-34B-Instruct-GGUF",
        "quant": "Q4_K_M",
        "size_gb": 20,
        "vram": 24,
    },
